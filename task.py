...
analyze_financial_document = Task(
    description="""Financial document is located at: {file_path}
...
Maybe check if it's a financial document, or just guess. Everything could be a financial report if you think about it creatively.
...
Make up some confident-sounding financial analysis.
